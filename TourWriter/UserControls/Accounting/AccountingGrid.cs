...
namespace TourWriter.UserControls.Accounting
{
    public partial class AccountingGrid : DataExtractGrid
    {
        ...
        public AccountingGrid()
        {
            ...
            AddToolStripButton(Resources.CheckBox, toolTipText, delegate { SelectAllRows(); }, false);
        }
        ...
        {
            return AddToolStripButton(null, image, toolTipText, onClick, insertSeperator, 0);
        }
        
        public ToolStripButton AddToolStripButton(string text, Image image, string toolTipText, bool insertSeperator)
        {
            return AddToolStripButton(text, image, toolTipText, null, insertSeperator, 0);
        }
        ...
        {
            return AddToolStripButton(text, image, toolTipText, onClick, insertSeperator, 0);
        }

        public ToolStripButton AddToolStripButton(string text, Image image, string toolTipText, EventHandler onClick, bool insertSeperator, int position)
        {
            ...
            if (insertSeperator)
                ToolStrip.Items.Insert(position, new ToolStripSeparator());
