...
namespace TourWriter.Modules.ItineraryModule.ReportControls
{
	...
	/// </summary>
	public class PricingDetail : System.Windows.Forms.UserControl
	{
		#region Member vars
		...
		public PricingDetail(ItinerarySet itinerarySet)
		{
			InitializeComponent();
		...
		private void PricingDetailed_Load(object sender, System.EventArgs e)
		{
		}
		...
		private void btnReport_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				report = new TourWriter.Reports.Itinerary.PricingDetailed(itinerarySet, toolSet);
		...
		private void InitializeComponent()
		{
            ...
            this.Load += new System.EventHandler(this.PricingDetailed_Load);
