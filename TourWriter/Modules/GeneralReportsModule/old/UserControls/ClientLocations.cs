...
namespace TourWriter.Modules.ReportsModule.old.UserControls
{
	...
	/// </summary>
	public class ClientLocations : System.Windows.Forms.UserControl
	{
		#region Member vars
		...
		private void ClientLocations_Load(object sender, System.EventArgs e)
		{
		...
		private void btnReport_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				report = new TourWriter.Reports.General.ClientLocations(
		...
		private void InitializeComponent()
		{
			...
			this.chksetRequestStatus.TabIndex = 74;
			// 
			// label1
			// 
			...
			this.chksetItineraryStatus.TabIndex = 76;
			// 
			// label2
			// 
			...
			this.Name = "ClientLocations";
			this.Size = new System.Drawing.Size(472, 384);
			this.Load += new System.EventHandler(this.ClientLocations_Load);
