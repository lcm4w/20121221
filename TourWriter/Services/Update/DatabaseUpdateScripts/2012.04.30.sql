...
BEGIN TRANSACTION
GO
if ((select VersionNumber from AppSettings) <> '2012.02.15' and (select VersionNumber from AppSettings) <> '2012.04.10')
...
GO
UPDATE [dbo].[AppSettings] SET [VersionNumber]='2012.04.30'
GO
