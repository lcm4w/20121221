...
-- cleanup old default reports
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\General\ClientLocations.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\General\Itineraries by Agent.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\General\Itineraries by Country.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\General\Itineraries by ServiceType.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\General\Itineraries by Source.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\General\Itineraries by User.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\General\ItineraryYield.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\General\SupplierPurchases.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\General\SupplierRates.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\Itinerary\ClientPricing.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\Itinerary\ClientPricingDetailed.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\Itinerary\ContactList.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\Itinerary\PricingDetailed.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\Itinerary\PricingSummary.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\Itinerary\SupplierRemittance.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\Itinerary\Voucher.rdlc'
--delete from [dbo].[Template] where [FilePath] = '\Templates\Reports\Supplier\WhoUsed.rdlc'
GO
