...
// TODO: this class is copied in TourWriter.DataAccess, need to move all here...
...
namespace TourWriter.Info.Services
{
	...
	public sealed class SqlHelper
	{
		...
		/// <returns>A valid SqlCommand object</returns>
		internal static SqlCommand CreateCommand(SqlConnection connection, string spName, bool autofillParamSourceNames) 
		{
			if( connection == null ) throw new ArgumentNullException( "connection" );
			if( spName == null || spName.Length == 0 ) throw new ArgumentNullException( "spName" );
