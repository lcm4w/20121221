...
#region sample version
using Infragistics.Win.UltraWinTree;
namespace TourWriter.Utilities.UltraTreeView.DragDropHelper
{
	...
	public class UltraTree_DropHighLight_DrawFilter_Class:Infragistics.Win.IUIElementDrawFilter
	{
		...
		public UltraTree_DropHighLight_DrawFilter_Class()
		{
...
{
	/// <summary>
	/// UltraTree_DropHighLight_DrawFilter_Class class for handling node drag-drop in UltraWinTree control.
	/// </summary>
	/// 
		...
		bool Infragistics.Win.IUIElementDrawFilter.DrawElement(Infragistics.Win.DrawPhase drawPhase, ref Infragistics.Win.UIElementDrawParams drawParams)
		{
			...
			switch (drawPhase)
			{
				...
				case Infragistics.Win.DrawPhase.AfterDrawElement:
				{
					...
					{
						//Declare a pen to us for drawing Droplines
						Pen p = new Pen(mvarDropLineColor, mvarDropLineWidth);
